...
date: 2026-03-14
pdf: "https://arxiv.org/pdf/2603.13784v2"
tags: ["query:ts"]
score: 7.0
...
## 摘要
本文引入了一类灵活的观测驱动型 $\mathbb{Z}$ 值时间序列模型，该模型由负分量和非负分量的混合构建而成。与基于标准 Skellam 分布或两个整数值变量之差的模型相比，我们的设定提供了更大的灵活性。例如，它能够轻松处理偏态和双峰性。此外，对混合模型中其中一个分量的观测使得解释和统计分析变得更加容易。我们建立了平稳性和混合性条件，并开发了一种具有渐近性质证明的混合泊松准极大似然估计量。提出了一种混成检验来诊断残差的序列相关性。通过模拟评估了该方法的有限样本性能，对跳动价格的实证应用证明了其在实际中的有用性。
